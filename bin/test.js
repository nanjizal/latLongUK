...
var latLongUK_demo_Main = function() {
	this.divertTrace = new htmlHelper_tools_DivertTrace();
	this.canvasSetup();
	this.vectorUK();
	this.demoLatLong();
};
latLongUK_demo_Main.__name__ = true;
latLongUK_demo_Main.main = function() {
	new latLongUK_demo_Main();
};
latLongUK_demo_Main.prototype = {
	...
	,demoLatLong: function() {
		...
		while(_g < _g1) {
			...
			var this2 = en;
			var flat = this2;
			temp[0] = new latLongUK_helpers_XY(flat.east * plot.scale + plot.dx,plot.negY - flat.north * plot.scale + plot.dy);
			var _g2 = -9;
			var _g11 = 2;
			while(_g2 < _g11) {
				var long = _g2++;
				...
				var this3 = en1;
				var flat1 = this3;
				temp[tempCount++] = new latLongUK_helpers_XY(flat1.east * plot.scale + plot.dx,plot.negY - flat1.north * plot.scale + plot.dy);
				var sp2 = new latLongUK_LatLong(lat,long + 0.25);
				var en2 = latLongUK_LatLongUK.ll_to_osOld(sp2);
				var this4 = en2;
				var flat2 = this4;
				temp[tempCount++] = new latLongUK_helpers_XY(flat2.east * plot.scale + plot.dx,plot.negY - flat2.north * plot.scale + plot.dy);
				var sp3 = new latLongUK_LatLong(lat,long + 0.5);
				var en3 = latLongUK_LatLongUK.ll_to_osOld(sp3);
				var this5 = en3;
				var flat3 = this5;
				temp[tempCount++] = new latLongUK_helpers_XY(flat3.east * plot.scale + plot.dx,plot.negY - flat3.north * plot.scale + plot.dy);
				var sp4 = new latLongUK_LatLong(lat,long + 0.75);
				var en4 = latLongUK_LatLongUK.ll_to_osOld(sp4);
				var this6 = en4;
				var flat4 = this6;
				temp[tempCount++] = new latLongUK_helpers_XY(flat4.east * plot.scale + plot.dx,plot.negY - flat4.north * plot.scale + plot.dy);
			}
			var sp5 = new latLongUK_LatLong(lat,3);
			var en5 = latLongUK_LatLongUK.ll_to_osOld(sp5);
			var this7 = en5;
			var flat5 = this7;
			temp[tempCount++] = new latLongUK_helpers_XY(flat5.east * plot.scale + plot.dx,plot.negY - flat5.north * plot.scale + plot.dy);
			arr[count++] = temp;
		}
		var _g21 = -9;
		var _g3 = 4;
		while(_g21 < _g3) {
			...
			var this8 = en6;
			var flat6 = this8;
			temp1[0] = new latLongUK_helpers_XY(flat6.east * plot.scale + plot.dx,plot.negY - flat6.north * plot.scale + plot.dy);
			var _g22 = 49;
			var _g31 = 60;
			while(_g22 < _g31) {
				var lat1 = _g22++;
				...
				var this9 = en7;
				var flat7 = this9;
				temp1[tempCount++] = new latLongUK_helpers_XY(flat7.east * plot.scale + plot.dx,plot.negY - flat7.north * plot.scale + plot.dy);
			}
			arr[count++] = temp1;
		}
		var lines = arr;
